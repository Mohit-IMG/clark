                                        ...
                                        <table class="table table-hover js-basic-example contact_list dataTable"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="center sorting" tabindex="0"
                                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                                        style="width: 126.333px;"
                                                        aria-label=" Name : activate to sort column ascending"> SKP
                                                    </th> 
                                                    <th class="center sorting" tabindex="0"
                                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
												...
												@if(!empty($result))
													@foreach($result as $key=>$value)
														<tr class="gradeX odd"  id="{{ $value->id }}">
                                                            ...
                                                            <td class="center">{{ ucfirst($value['skill_name']) }}</td>
                                                            <td class="center">{{ $value['skp'] }}%</td>
															<td class="center">
                                                            ...
                                                            <td class="center">
                                                                ...
                                                                <a href="{{ url('admin/skills/update/'.$value['id'] )}}" title="Edit Skill" class="btn btn-tbl-edit">
                                                                    <i class="fas fa-pencil-alt"></i>
                                                                </a>
                                                                <a title="Delete Skill" onclick="return confirm('Are you sure? You want to delete this Skill.')" href="{{ url('admin/skills/delete/'.$value['id'] )}}" class="btn btn-tbl-delete">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th class="center" rowspan="1" colspan="1"> Skill </th>	
                                                    <th class="center" rowspan="1" colspan="1"> SKP </th>	
