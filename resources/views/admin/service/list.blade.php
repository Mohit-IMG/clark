    ...
    <div class="container-fluid">
				...
				<div class="card">
					...
					<div class="body">
						<div class="btn-group top-head-btn">
                            <a class="btn-primary" href="{{ url('admin/service/add') }}">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
					<div class="header">
						<h2><i class="fa fa-th"></i> Service List</h2>
					</div>
                    <div class="body">
                                        ...
                                        <table class="table table-hover js-basic-example contact_list dataTable"
												...
												@if(!empty($result))
													@foreach($result as $key=>$value)
														<tr class="gradeX odd"  id="{{ $value->id }}">
                                                            ...
                                                            <td>{{ \App\Helpers\CommonHelper::getUserName($value['user_id']) }}</td>
                                                            <td class="center">{{ ucfirst($value['description']) }}</td>
                                                            <td class="center">{{ ucfirst($value['service_name']) }}</td>
															<td class="center">
                                                            ...
                                                            <td class="center">
                                                                ...
                                                                <a href="{{ url('admin/service/update/'.$value['id'] )}}" title="Edit Service" class="btn btn-tbl-edit">
                                                                    <i class="fas fa-pencil-alt"></i>
                                                                </a>
                                                                <a title="Delete Service" onclick="return confirm('Are you sure? You want to delete this Service.')" href="{{ url('admin/service/delete/'.$value['id'] )}}" class="btn btn-tbl-delete">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th class="center" rowspan="1" colspan="1"> Provider </th>	
