   ...
   <div class="container-fluid">
            ...
            <div class="card">
               ...
               <div class="body">
                  <div class="btn-group top-head-btn">
                     <a class="btn-primary" href="{{ url('admin/slider/add') }}">
      ...
      <div class="row">
         <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
               <div class="header">
                  <h2><i class="fa fa-th"></i> Slider List</h2>
               </div>
               <div class="body">
                  <div class="table-">
                              ...
                              <table class="table table-hover js-basic-example contact_list dataTable"
                                 ...
                                 <tbody class="row_position">
                                    ...
                                    <tr class="gradeX odd"  id="{{ $value->id }}">
                                       ...
                                       <td class="center"><img src="{{ asset('uploads/sliders/'.$value->image) }}" width="65px"/></td>
                                       <td class="center">
                                          <div class="switch mt-3">
                                             <label>
                                             <input type="checkbox" class="-change4" data-id="{{ $value['id'] }}"@if($value['status']=='Active'){{ 'checked' }} @endif>
                                             <span class="lever switch-col-red layout-switch"></span>
                                             </label>
                                          </div>
                                       </td>
                                       <td class="center">
                                          <a href="{{ url('admin/slider/update/'.$value['id'] )}}" title="Edit Slider" class="btn btn-tbl-edit">
                                          <i class="fas fa-pencil-alt"></i>
                                          </a>
                                          <a title="Delete Slider" onclick="return confirm('Are you sure? You want to delete this slider.')" href="{{ url('admin/slider/delete/'.$value['id'] )}}" class="btn btn-tbl-delete">
...
<script type="text/javascript">
   ...
   function updateOrder(aData) {        
    $.ajax({
        url:"{{route('admin.slider.change-order')}}",
